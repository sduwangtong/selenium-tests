...
//            driver.findElement(By.xpath(xpath_author)).click();
//            driver.findElement(By.xpath(xpath_author)).sendKeys(author);
//            driver.findElement(By.xpath(xpath_author)).sendKeys(Keys.RETURN);
            ...
            javaScriptHandleHiddenInput(xpath_hiddenInput);
            driver.findElement(By.className(xpath_hiddenInput)).sendKeys(image);
    ...
    private void checkArticle( String author, String webSite, String headline) {
        ...
        //wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpath_inReviewTab)));
        driver.findElement(By.xpath(xpath_inReviewTab)).click();
       // wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpath_review_headline)));
